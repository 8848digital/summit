...
import summitapp.api.v2.cyu_categories as cyu_categories
...
class V2:
	def __init__(self):
		self.methods = {
			...
			"cyu_categories": ["get_cyu_categories", "get_top_categories"],
